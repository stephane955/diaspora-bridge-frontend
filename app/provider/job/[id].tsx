...
import {
    ...
    Alert, ActivityIndicator, Dimensions, StatusBar, Platform
} from 'react-native';
...
export default function JobDetailsScreen() {
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Added paddingBottom: 150 so text isn't hidden behind the floating footer */}
            <ScrollView contentContainerStyle={{ paddingBottom: 150 }} bounces={false}>
                ...
                <View style={styles.imageContainer}>
                    ...
                    <View style={styles.titleContainer}>
                        <View style={styles.tag}>
                            <Text style={styles.tagText}>OPEN OPPORTUNITY</Text>
                        </View>
                ...
                <View style={styles.body}>
                    ...
                    <View style={styles.reqList}>
                        ...
                        <View style={styles.reqItem}>
                            <Ionicons name="checkmark-circle" size={20} color="#16A34A" />
                            <Text style={styles.reqText}>Milestone-based payments</Text>
                        </View>
                    </View>
                </View>
            </ScrollView>
            ...
            <View style={styles.footer}>
                ...
                <TouchableOpacity
                    style={[styles.acceptBtn, hasApplied && { backgroundColor: '#94A3B8' }]}
                    onPress={handleApply}
                    disabled={hasApplied || accepting}
                >
                    {hasApplied ? (
                        <>
...
const styles = StyleSheet.create({
    ...
    // YOUR FIXED FOOTER STYLE
    footer: {
        position: 'absolute',
        bottom: 90, // <--- Lifts above tab bar
        left: 20,
        right: 20,
        borderRadius: 20,
        backgroundColor: '#fff',
